...
def _getLocalRoot() -> PlatformDirsABC:
    ...
    derive appauthor and appname. Otherwise set appauther to 'gtvfx' and 
    appname to the env var value of 'ENVOY_TEAM'.
    ...
    return PlatformDirs(appauthor="gtvfx", appname=os.getenv("ENVOY_TEAM"))
